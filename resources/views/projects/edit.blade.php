      ...
      <div class="card">
          ...
          <div class="card-body">
            <form action="{{route('proyecto.update',$project->id)}}" method="POST" >
                ...
                {{\Carbon\Carbon::parse($project->datetime)->format('m/d/Y g:i A')}}
                  ...
                  <div class="row my-3">
                    ...
                    <div class="col-md-6">
                        ...
                        value="{{old('datetime', \Carbon\Carbon::parse($project->datetime)->format('Y-m-d\TH:i:s'))}}"  id="" aria-describedby="helpId" placeholder="">
                        @error('datetime')
                            <div class="row"><small class="text-danger col-md" style="font-weight: bold;"">{{$message}}</small></div>         
                        @enderror
                    </div>
