<div>
    ...
    <div class="card col-8">
       <div class="card-header">
           <input type="text" name="search" class="form-control" placeholder="Ingrese nombre de grupo empresa o nombre de proyecto"wire:model="search" id="">
       </div>
       <div class="card-body">
           <table class="table table-striped">
               <thead>
                ...
                @endif
                   ...
                   <th style="cursor: pointer;" wire:click="order('long_name')">Nombre Proyecto
                ...
                @endif
                   ...
                   <th style="cursor: pointer;" wire:click="order('name')">Estado
